...
val1 <- val.fn(m1)
write.table(val1,paste("/home/hduser/Documents/R/Iris_output/Testing-Iris-virginica.txt"))

########----------increase features in class Iris-setosa-------------------####

m2 <- read.table ("/home/hduser/Documents/R/Iris_output/Iris-setosa.txt", sep = "")
val2 <- val.fn(m2)
write.table(val2,paste("/home/hduser/Documents/R/Iris_output/Testing-Iris-setosa.txt"))

########----------increase features in class Iris-versicolor------------------####

m3 <- read.table ("/home/hduser/Documents/R/Iris_output/Iris-versicolor.txt", sep = "")
val3 <- val.fn(m3)
write.table(val3,paste("/home/hduser/Documents/R/Iris_output/Testing-Iris-versicolor.txt"))