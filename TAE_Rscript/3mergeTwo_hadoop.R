...
data <- read.table ("/home/hduser/Documents/R/TAE_output/tae.data.txt", sep = "")
...
data.reduce.fn <- function(k,v){  
  keyval(k,v)
  write.table(v,paste("/home/hduser/Documents/R/TAE_output/cc12_hadoop.txt"))
}
